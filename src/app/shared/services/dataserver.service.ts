...
import { peopleWithTotalCount } from '../models/peopleWithTotalCount';
...
export class DataServerService {
  ...
  // getPeopleCountFromServer(): Observable<number>{
  //   return this.http.get<number>(environment.URLBASE + 'api/people/getpeoplecount');
  // }
